...
impl MeasurementResult for CSP2MeasurementResult {
    const OWN_HEADER : &'static str= "num_queue_pushes,num_settled,num_labels_propagated,num_labels_reset,num_nodes_searched,time_ms,path_distance,path_number_nodes,path_number_flagged_nodes,path_number_short_pauses,path_number_long_pauses";
