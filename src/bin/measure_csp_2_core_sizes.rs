...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for current_core_size in rel_core_sizes {
        ...
        core_ch_chpot_query.set_restriction(32_400_000, 32_400_000, 16_200_000, 2_700_000);
    ...
    let file = File::create("measure_csp_2_core_sizes-".to_owned() + path.file_name().unwrap().to_str().unwrap() + ".txt")?;
