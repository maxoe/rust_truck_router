...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    impl MeasurementResult {
        const HEADER : &'static str= "max_driving_time_ms,num_queue_pushes,num_settled,num_labels_propagated,num_labels_reset,num_nodes_searched,time_ms,path_distance,path_number_nodes,path_number_flagged_nodes,path_number_pauses";

        pub fn as_csv(&self) -> String {
            if self.path_distance.is_some() {
                format!(
                    "{},{},{},{},{},{},{},{},{},{},{}",
                    self.max_driving_time_ms,
